...
imgMongoldiera.style.cssText += 'height:' + ($(this).height() + 150) + 'px';
imgDirigibile.style.cssText += 'height:' + ($(this).height() + 150) + 'px;'
imgDeltaplano.style.cssText += 'height:' + ($(this).height() + 150) + 'px;';
});
